...
(function () {
  ...
  /* 어디까지 펼치고 어디부터 가릴지.
   *
   * 예전에는 챕터 5개·보스 4개만 보여 줬는데, 섹션마다 "나머지는 직접 확인하세요"가
   * 반복되니 신비감이 아니라 "감출 만큼 없나"로 읽혔다. 처음 보는 이름 없는 게임의
   * 페이지에서는 약속보다 증거가 먼저다.
   *
   * 그래서 기준을 이야기의 마디에 맞췄다 — 1부(서장 ~ 제7장)는 그대로 펼치고,
   * 종장부터가 결말이라 거기서 자른다. 보스도 같은 선에서 끊는다.
   * 임의의 숫자가 아니라 설명할 수 있는 선이라, 페이지에서 한 번만 말하면 된다. */
  ...
  var CHAPTERS = [
    [0,  '서장',            '떨어진 별',               '별이 부서진 밤',                        'chapter_0_fallen_star'],
    [1,  '제1장',          '잿빛 야영지',             '혼자이지 않기를 꿈꾼 것',               'chapter_1_ash_village'],
    [2,  '제2장',          '뼈가 쌓인 곳',            '잠든 것들의 꿈을 대신 꾼 조각',         'chapter_2_bone_pit'],
    [3,  '제3장',          '부패한 숲',               '굶주림을 꿈꾼 것',                      'chapter_3_corrupt_forest'],
    [4,  '제4장',          '서리 왕좌',               '조각을 재우지 않은 사람',               'chapter_4_frost_throne'],
    [5,  '제5장',          '별이 잠든 땅',            '꿈꿀 필요가 없었던 조각',               'chapter_5_sleeping_star'],
    [6,  '제6장',          '구름 위의 계단',          '이 일은 처음이 아니었다',               'chapter_6_sky_stair'],
    [7,  '제7장',          '최초의 유적',             '우리보다 잘하라',                      'chapter_7_first_ruin'],
    [8,  '종 장',            '별을 쫓아온 것',          '이번에는 넘기지 않는다',                'chapter_8_pursuer'],
    [9,  '세션 2 · 서장',   '아무도 세우지 않은 도시', '손자국이 하나도 없다',                  'chapter_9_nobody_built'],
    [10, '세션 2 · 제1장', '지하 공창',               '멈추라고 가르친 사람이 없었다',         'chapter_10_underworks'],
    [11, '세션 2 · 제2장', '굴뚝이 선 마을',          '하루아침에 늘어난 것',                  'chapter_11_chimneys'],
    [12, '세션 2 · 제3장', '폭주로',                  '결재자 없음 — 자동 승인',               'chapter_12_runaway'],
    [13, '세션 2 · 제4장', '헤파',                    '멈추면 아무도 남지 않는다',             'chapter_13_hepha'],
    [14, '세션 2 · 종 장',   '벽 너머',                 '남기고 간 것이 아니라, 남아 있던 것',   'chapter_14_beyond_wall'],
    [15, '세션 3 · 서장',   '물이 지운 쪽',            '서쪽 끝, 지도가 끊기는 자리',           'chapter_15_drowned'],
    [16, '세션 3 · 제1장', '내려갈수록 밝은 것',      '빛이 닿은 적 없는 곳에서 빛나는 것들',  'chapter_16_lanterns'],
    [17, '세션 3 · 제2장', '가라앉은 종',             '물이 대신 대답한다',                    'chapter_17_bell']
  ];
   ...
   *
   * ★ 이 폭·높이는 **manifest.json 을 다시 보고 옮겨 적어야 한다.** 여기 적힌 값이
   *   시트보다 작으면 잘린 보스가 카드에 뜬다 — tools/padframe.py 가 칸 가장자리에
   *   닿은 시트에 여백을 주면서 열두 마리가 전부 한두 칸씩 커졌는데, 그때 이 표가
   *   안 따라와서 슬라임 왕이 82×62(실제 86×64)로 잘려 있었다. */
  var BOSS_SCALE = 4;
  var BOSSES = [
    ['king_slime',    '슬라임 왕',                   '제1장',           900,  86,  64],
    ['bone_lord',     '뼈의 군주',                   '제2장',          2000,  60,  76],
    ['corrupt_heart', '부패의 심장',                 '제3장',          3600,  68,  65],
    ['frost_witch',   '서리 마녀 실비아',            '제4장',          5600,  38,  58],
    ['void_king',     '공허의 왕',                   '제5장',         12000,  78,  95],
    ['storm_warden',  '폭풍의 수호자',               '제6장',         13000,  66,  70],
    ['first_keeper',  '최초의 파수꾼',               '제7장',         20000,  74,  91],
    ['pursuer',       '별을 쫓아온 것',              '종 장',           42000, 204, 214],
    ['overseer',      '공창의 관리자',               '세션 2 · 1 장',   30000,  80,  95],
    ['proliferator',  '증식체',                      '세션 2 · 3 장',   46000,  76,  66],
    ['hepha',         '헤파 · 최초의 기계',          '세션 2 · 4 장',   72000, 188, 226],
    ['archetype',     '원형 · 첫 번째 설계',         '세션 2 · 종 장', 105000, 192, 232],
    ['tide_warden',   '조수의 파수꾼 · 물이 지운 것', '세션 3 · 2 장',  148000, 104, 120]
  ];
