...
(function () {
   ...
   * 페이지에서는 약속보다 증거가 먼저다.
   *
   * 그래서 기준을 이야기의 마디에 맞췄다 — 1부(서장 ~ 제 7 장)는 그대로 펼치고,
  ...
  var CHAPTERS = [
    ...
    [7,  '제 7 장',          '최초의 유적',             '우리보다 잘하라',                      'chapter_7_first_ruin'],
    ...
    [16, '세션 3 · 제 1 장', '내려갈수록 밝은 것',      '빛이 닿은 적 없는 곳에서 빛나는 것들',  'chapter_16_lanterns'],
    [17, '세션 3 · 제 2 장', '가라앉은 종',             '물이 대신 대답한다',                    'chapter_17_bell']
  ];
  ...
  var BOSS_SCALE = 4;
  var BOSSES = [
    ['king_slime',    '슬라임 왕',                   '제 1 장',           900,  86,  64],
    ['bone_lord',     '뼈의 군주',                   '제 2 장',          2000,  60,  76],
    ['corrupt_heart', '부패의 심장',                 '제 3 장',          3600,  68,  65],
    ['frost_witch',   '서리 마녀 실비아',            '제 4 장',          5600,  38,  58],
    ['void_king',     '공허의 왕',                   '제 5 장',         12000,  78,  95],
    ['storm_warden',  '폭풍의 수호자',               '제 6 장',         13000,  66,  70],
    ['first_keeper',  '최초의 파수꾼',               '제 7 장',         20000,  74,  91],
