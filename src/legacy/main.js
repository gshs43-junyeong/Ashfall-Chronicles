...
for (const m of [e_math, e_rng, e_noise, e_color, e_rle, e_seal, e_upgrade, e_store, e_aurl, e_music, e_sfx, e_amb, e_image, e_loop, e_view, e_actions, e_pointer, e_touch, e_tilemap, e_pipeline, e_atlas, e_conn, util, size, data, world, tileart, itemart, sprites, titlebg, entity, factory, ui, music, game]) {
